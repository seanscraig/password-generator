...
function generatePassword() {
  ...
  while (!validLength) {
    var passwordLength = prompt(
      "Please enter the desired length of the password (Must be between 8 and 128 characters):",
      "enter length"
    );
  ...
  var charLowerPrompt = confirm(
    "Would you like to use lower case letters in your password? (i.e. abcde)"
  );
  var charUpperPrompt = confirm(
    "Would you like to use upper case letters in your password? (i.e. ABCDE"
  );
  var charNumPrompt = confirm(
    "Would you like to use numbers in your password? (i.e. 12345)"
  );
  var charsSpecialPrompt = confirm(
    "Would you like to use special characters in your password? (i.e. !@#$%)"
  );
  ...
  // We can concatenate all the randomly selected characters into one string but leaves 
